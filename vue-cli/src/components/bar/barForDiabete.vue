          ...
          series: [
            {
              ...
              barWidth: 20,
              data: [this.allData[8][1][3][1],this.allData[1][1][3][1],this.allData[6][1][3][1],this.allData[5][1][3][1],
              this.allData[2][1][3][1],this.allData[4][1][3][1],this.allData[7][1][3][1],this.allData[3][1][3][1]]
            }
          ]
        }
      }
