...
while True:
    ...
    search_results = api.search(count=100, geocode='-31.9505,115.8605,100km', lang='en',max_id=maxId,since_id=1256430898481778689)
    # search_results = api.search(count=100, geocode='-31.9505,115.8605,100km', lang='en')
