...
# db = server.create('tweet_lockdown')
db = server['tweet_lockdown']
...
while True:
    ...
    search_results = api.search(q='lockdown',count=100, lang='en',until='2020-04-22',max_id=maxId)
