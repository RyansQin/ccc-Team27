...
while True:
    ...
    search_results = api.search(count=100, geocode='-27.4698,153.0251,50km',lang='en',max_id=maxId,since_id=1256431319007068161)
    # search_results = api.search(count=100, geocode='-27.4698,153.0251,50km', lang='en')
