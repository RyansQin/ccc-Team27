...
while True:
    ...
    search_results = api.search(count=100, geocode='-33.8688,151.2093,100km',lang='en',max_id=maxId,since_id=1256430415729975296)
    # search_results = api.search(count=100, geocode='-33.8688,151.2093,100km', lang='en')
