...
while True:
    ...
    search_results = api.search(count=100, geocode='-41.4545,145.9707,100km',lang='en',max_id=maxId,since_id=1256427767152783360)
    # search_results = api.search(count=100, geocode='-41.4545,145.9707,100km', lang='en')
