...
while True:
    ...
    search_results = api.search(count=100, geocode='-12.4634,130.84560,200km',lang='en',max_id=maxId)
    # search_results = api.search(count=100, geocode='-12.4634,130.8456,200km', lang='en')
