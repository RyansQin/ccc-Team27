...
while True:
    ...
    search_results = api.search(count=100, geocode='-37.8136,144.9631,100km',lang='en',max_id=maxId,since_id=1256430125706428420)
    # search_results = api.search(count=100, geocode='-37.8136,144.9631,100km', lang='en')
