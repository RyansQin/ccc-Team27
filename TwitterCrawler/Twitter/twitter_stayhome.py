...
# db = server.create('tweet_stayhome')
db = server['tweet_stayhome']
...
while True:
    ...
    search_results = api.search(q='#stayhome or 123',count=100, lang='en',until='2020-04-22',max_id=maxId)
    ...
    for tweet in search_results:
        ...
        if 'text' in tweet._json and tweet._json['text'][0:2] != 'RT':
            ...
            print()
            # if hash(tweet._json['text']) in hash_list:
            #     print('重复了！！！！！')
            # else:
            # print('1')
