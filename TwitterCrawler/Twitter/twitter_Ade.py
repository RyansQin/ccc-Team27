...
while True:
    ...
    search_results = api.search(count=100, geocode='-34.9285,138.6007,100km', lang='en',max_id=maxId,since_id=1256431643864084481)
    # search_results = api.search(count=100, geocode='-34.9285,138.6007,100km', lang='en')
