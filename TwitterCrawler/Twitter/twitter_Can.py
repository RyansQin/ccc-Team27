...
while True:
    ...
    search_results = api.search(count=100, geocode='-35.2809,149.1300,20km',lang='en',max_id=maxId,since_id=1256464864249176064)
    # search_results = api.search(count=100, geocode='-35.2809,149.1300,20km', lang='en')
