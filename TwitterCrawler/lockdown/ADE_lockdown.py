...
# db = server.create('lockdown_ade')
db = server['lockdown_ade']
...
while True:
    ...
    # search_results = api.search(q='lockdown', count=100, geocode='-34.9285,138.6007,100km', lang='en', max_id=maxId, since_id=1257840843546746880)
    # search_results = api.search(q='lockdown', count=100, geocode='-34.9285,138.6007,100km', lang='en')
    # search_results = api.search(q='stayhome', count=100, geocode='-34.9285,138.6007,100km', lang='en', max_id=maxId, since_id=1257677823134711814)
    # search_results = api.search(q='stayhome', count=100, geocode='-34.9285,138.6007,100km', lang='en')
    search_results = api.search(q='stay home', count=100, geocode='-34.9285,138.6007,100km', lang='en', max_id=maxId, since_id=1257807333683425280)
    # search_results = api.search(q='stay home', count=100, geocode='-34.9285,138.6007,100km', lang='en')
