...
# db = server.create('lockdown_vic')
db = server['lockdown_vic']
...
while True:
    ...
    # search_results = api.search(q='lockdown',count=100, geocode='-37.8136,144.9631,100km',lang='en',max_id=maxId, since_id=1257837486102855680)
    # search_results = api.search(q='lockdown', count=100, geocode='-37.8136,144.9631,100km', lang='en')
    # search_results = api.search(q='stayhome', count=100, geocode='-37.8136,144.9631,100km', lang='en', max_id=maxId, since_id=1257839731921936384)
    # search_results = api.search(q='stayhome', count=100, geocode='-37.8136,144.9631,100km', lang='en')
    search_results = api.search(q='stay home', count=100, geocode='-37.8136,144.9631,100km', lang='en', max_id=maxId, since_id=1257837506126585857)
    # search_results = api.search(q='stay home', count=100, geocode='-37.8136,144.9631,100km', lang='en')
