...
# db = server.create('lockdown_tas')
db = server['lockdown_tas']
...
while True:
    ...
    # search_results = api.search(q='lockdown', count=100, geocode='-41.4545,145.9707,100km',lang='en',max_id=maxId, since_id=1257775093624836099)
    # search_results = api.search(q='lockdown', count=100, geocode='-41.4545,145.9707,100km', lang='en')
    # search_results = api.search(q='stayhome', count=100, geocode='-41.4545,145.9707,100km', lang='en', max_id=maxId, since_id=1256856252337938438)
    # search_results = api.search(q='stayhome', count=100, geocode='-41.4545,145.9707,100km', lang='en')
    search_results = api.search(q='stay home', count=100, geocode='-41.4545,145.9707,100km', lang='en', max_id=maxId, since_id=1257817959168274433)
    # search_results = api.search(q='stay home', count=100, geocode='-41.4545,145.9707,100km', lang='en')
