...
while True:
    ...
    # search_results = api.search(q='lockdown', count=100, geocode='-12.4634,130.84560,200km',lang='en',max_id=maxId, since_id=1257693173570138113)
    # search_results = api.search(q='lockdown', count=100, geocode='-12.4634,130.84560,200km', lang='en')
    # search_results = api.search(q='stayhome', count=100, geocode='-12.4634,130.84560,200km', lang='en', max_id=maxId, since_id=1254941632606040065)
    # search_results = api.search(q='stayhome', count=100, geocode='-12.4634,130.84560,200km', lang='en')
    search_results = api.search(q='stay home', count=100, geocode='-12.4634,130.84560,200km', lang='en', max_id=maxId, since_id=1256808016642371584)
    # search_results = api.search(q='stay home', count=100, geocode='-12.4634,130.84560,200km', lang='en')
