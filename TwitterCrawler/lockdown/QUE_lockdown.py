...
# db = server.create('lockdown_que')
db = server['lockdown_que']
...
while True:
    ...
    # search_results = api.search(q='lockdown', count=100, geocode='-27.4698,153.0251,50km',lang='en',max_id=maxId, since_id=1257837251909672960)
    # search_results = api.search(q='lockdown', count=100, geocode='-27.4698,153.0251,50km', lang='en')
    # search_results = api.search(q='stayhome', count=100, geocode='-27.4698,153.0251,50km', lang='en', max_id=maxId, since_id=1257810765173547008)
    # search_results = api.search(q='stayhome', count=100, geocode='-27.4698,153.0251,50km', lang='en')
    search_results = api.search(q='stay home', count=100, geocode='-27.4698,153.0251,50km', lang='en', max_id=maxId, since_id=1257822552639942656)
    # search_results = api.search(q='stay home', count=100, geocode='-27.4698,153.0251,50km', lang='en')
