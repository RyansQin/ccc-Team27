...
while True:
    ...
    # search_results = api.search(q='lockdown', count=100, geocode='-35.2809,149.1300,20km',lang='en',max_id=maxId, since_id=1257838288334761984)
    # search_results = api.search(q='lockdown', count=100, geocode='-35.2809,149.1300,20km', lang='en')
    # search_results = api.search(q='stayhome', count=100, geocode='-35.2809,149.1300,20km', lang='en', max_id=maxId, since_id=1257798212200456192)
    # search_results = api.search(q='stayhome', count=100, geocode='-35.2809,149.1300,20km', lang='en')
    search_results = api.search(q='stay home', count=100, geocode='-35.2809,149.1300,20km', lang='en', max_id=maxId, since_id=1257829990583857152)
    # search_results = api.search(q='stay home', count=100, geocode='-35.2809,149.1300,20km', lang='en')
